...
class App extends React.Component {
  gettingWeather = async ()=> { // async получение информации асинхронно без обновления страницу
    const api_url = await fetch(`api.openweathermap.org/data/2.5/weather?q=Moscow.ru&appid=${API_KEY}&units=metric`);// константа для ссылки где получаем json информацию fetch для прохождения 
    // по всему URL
